...
class Disease(BaseImageDataset):

    def __init__(self, root='', second_dir = '',verbose=True, pid_begin=0, **kwargs):
        super(Disease, self).__init__()
        self.dataset_dir = osp.join(root, second_dir)
        print("================Dataset path==================: ",self.dataset_dir)
